    ...
    <div class="m-20">
        ...
        <form @submit.prevent="createBarang" class="mt-4">
            <div class="flex flex-col space-y-4">
                ...
                <nuxt-link to="../../barang"> <button type="submit" class="btn-create bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-md
           focus:outline-none focus:ring focus:ring-blue-500">Tambah</button></nuxt-link>
            </div>
        </form>
